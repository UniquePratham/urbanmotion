...
import { Box, Text, VStack, HStack, Spinner, Input, Button, IconButton, Image, Select, SimpleGrid } from '@chakra-ui/react';
...
const Card = ({ userType, userData }) => {
  ...
  const handleSave = () => {
    setIsEditable(false);
    setIsFlipped(false);
    // onSave(formData); // Send updated data to the backend
  };
